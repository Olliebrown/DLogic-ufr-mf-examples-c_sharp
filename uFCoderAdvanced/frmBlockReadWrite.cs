            ...
            try
            {
                ...
                DL_STATUS iFResult;
                    ...
                    unsafe
                    {
                        ...
                        {
                            iFResult = uFCoder.BlockRead(PData, uiBlockAddress, bAuthMode, bKeyIndex);
                        }
                    }
                    if (iFResult == DL_OK)
                    {
        ...
        private void btnBlockReadAKM1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                unsafe
                {
                    fixed (byte* PData = baBlockData)
                    {
                        iFResult = uFCoder.BlockRead_AKM1(PData,uiBlockAddress, bAuthMode);
                    }
                }
                if (iFResult == DL_OK)
                {
        ...
        private void btnBlockReadAKM2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                unsafe
                {
                    fixed (byte* PData = baBlockData)
                    {
                        iFResult = uFCoder.BlockRead_AKM2(PData, uiBlockAddress, bAuthMode);
                    }
                }
                if (iFResult == DL_OK)
                {
        ...
        private void btnBlockAddressPK_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                unsafe
                {
                    ...
                    {
                        iFResult = uFCoder.BlockRead_PK(PData, uiBlockAddress, bAuthMode,PKKey);
                    }
                }
                if (iFResult == DL_OK)
                {
        ...
        private void btnBlockWrite_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                unsafe
                {
                    ...
                    {
                        iFResult = uFCoder.BlockWrite(PData, uiBlockAddress, bAuthMode, bKeyIndex);
                    }
                }
                if (iFResult == DL_OK)
                {                    
        ...
        private void btnBlockWriteAKM1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                unsafe
                {
                    fixed (byte* PData = baWriteData)
                    {
                        iFResult = uFCoder.BlockWrite_AKM1(PData, uiBlockAddress, bAuthMode);
                    }
                }
                if (iFResult == DL_OK)
                {
        ...
        private void btnBlockWriteAKM2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                unsafe
                {
                    fixed (byte* PData = baWriteData)
                    {
                        iFResult = uFCoder.BlockWrite_AKM2(PData, uiBlockAddress, bAuthMode);
                    }
                }
                if (iFResult == DL_OK)
                {
            ...
            try
            {
                ...
                unsafe
                {
                    fixed (byte* PData = baWriteData,
                                 PKKey = baPKKey)
                    {
                        iFResult = uFCoder.BlockWrite_PK(PData, uiBlockAddress, bAuthMode,PKKey);
                    }
                }
                if (iFResult == DL_OK)
                {
